...
function handleVideoUpload(input) {
  ...
  card.innerHTML = '<div class="video-thumb" onclick="playUploaded(this, \'' + url + '\')"><span class="play-btn">▶</span><span class="duration">آپلود شده</span></div><div class="card-body"><span class="badge">آپلود شما</span><h3>' + file.name + '</h3><p class="muted">همین الان</p></div>';
  grid.prepend(card);
  alert('ویدیو «' + file.name + '» اضافه شد.');
}
